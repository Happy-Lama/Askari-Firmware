...
char number1[14]; //= "+256754319267";
char number2[14]; //= "+256702357235";
char number3[14]; //= "+256781150481";

String number1_str = "0000000000000";
String number2_str = "0000000000000";
String number3_str = "0000000000000";
...
void setup() {
  ...
  number1_str.toCharArray(number1, 14);
  number2_str.toCharArray(number2, 14);
  number3_str.toCharArray(number3, 14);
